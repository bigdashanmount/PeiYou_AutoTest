...
time.sleep(1)
driver.find_element_by_id("com.stoneenglish:id/view_shared_tabbar_study_title").click()
time.sleep(1)
driver.find_element_by_id("com.stoneenglish:id/exchange_class").click()
time.sleep(1)
driver.find_element_by_id("com.stoneenglish:id/tvAdjustNum").click()
